export const filmDetailsBlock = (filmData) => `<section class="film-details">
      ...
      <div class="film-details__info-wrap">
        <div class="film-details__poster">
          <img class="film-details__poster-img"
           src="./images/posters/${filmData.postFail}" alt="">
        ...
        <div class="film-details__info">
          <div class="film-details__info-head">
            <div class="film-details__title-wrap">
              <h3 class="film-details__title">${filmData.name}</h3>
              <p class="film-details__title-original">
                Original: ${filmData.name}
              </p>
            </div>
          ...
          <table class="film-details__table">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">30 March ${filmData.year}</td>
            </tr>
            <tr class="film-details__row">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">
                <span class="film-details__genre">${filmData.ganre}</span>
